...
// Temporarily hardcode your values here
const supabaseUrl = 'https://pwvqfbmzutbmimderfnf.supabase.co'
const supabaseAnonKey = 'sb_publishable_ldl-bH7t9ggsH4oQCwjoag_6YRf0HJf'
...
async function seedData() {
  ...
  if (error) {
    ...
    console.log('✅ Successfully added', dummyMeals.length, 'meals!')
  }
}
